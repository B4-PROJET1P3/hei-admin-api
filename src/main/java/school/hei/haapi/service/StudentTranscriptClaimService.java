...
public class StudentTranscriptClaimService {
    ...
    public StudentTranscriptClaim save(StudentTranscriptClaim toSave, String claimId,
        ...
        Transcript transcript = transcriptRepository.getTranscriptByIdAndStudentId(transcriptId, studentId)
                .orElseThrow(() -> new NotFoundException(
                        "Transcript.Id = " + transcriptId + "for Student.Id=" + studentId + " not found"));
        if (transcript.getIsDefinitive()) {
            throw new BadRequestException("Cannot make claim anymore, " + transcriptId + " is already definitive");
        }
