...
@Repository
public interface StudentTranscriptVersionRepository
    extends JpaRepository<StudentTranscriptVersion, String> {
  ...
  Optional<StudentTranscriptVersion> getByIdAndStudentIdAndTranscriptId(
