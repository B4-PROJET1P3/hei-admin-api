...
class StudentTranscriptClaimIT {
    ...
    @Test
    @Order(10)
    void teacher_write_claim_on_a_definitive_transcript_ok() throws ApiException {
        ApiClient manager1Client = anApiClient(MANAGER1_TOKEN);
        TranscriptApi api = new TranscriptApi(manager1Client);
        ...
        assertThrowsApiException(
                "{\"type\":\"400 BAD_REQUEST\",\"message\":\"Cannot make claim anymore, transcript3_id is already definitive\"}",
                () -> api.putStudentClaimsOfTranscriptVersion(STUDENT2_ID, TRANSCRIPT3_ID, TRANSCRIPT3_VERSION1_ID, TRANSCRIPT3_VERSION1_CLAIM1_ID, toUpdate));
